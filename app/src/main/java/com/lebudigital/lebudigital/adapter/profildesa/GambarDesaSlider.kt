...
class GambarDesaSlider() :
    SliderViewAdapter<GambarDesaSlider.VH>() {
    private var mSliderItems = ArrayList<String>()
    private var mSliderModel = mutableListOf<GambarDesaModel>()
    ...
    interface Dialog {
        fun onClick(
            position: Int,
            note: GambarDesaModel
        )
    }
    fun renewItems(sliderItems: ArrayList<String>,slidermodel : MutableList<GambarDesaModel>) {
